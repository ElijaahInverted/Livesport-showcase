export const BOOKMAKERS = [
  ...
  },
  {
    id: "G",
    name: "Bookmaker G",
    label: "Best for horse racing",
    color: "#D97706",
    rating: 4.2,
    bonus: "Bet £10, Get £40 in Free Bets",
    bonusShort: "£40 Free Bets",
    minDeposit: 10,
    licence: "UKGC licensed",
    pros: ["Best Odds Guaranteed daily", "Racing live streams", "Totepool integration"],
    cons: ["Football coverage is average", "App feels dated on Android"],
    summary:
      "A specialist racing operator offering Best Odds Guaranteed on every UK and Irish meeting, integrated Totepool bets and live streaming of thousands of races per year.",
    ratings: { Odds: 4.6, Markets: 4.3, App: 4.0, Payments: 4.3, Support: 4.1 },
    positioning: "Best bookmaker for UK and Irish horse racing",
  },
  {
    id: "H",
    name: "Bookmaker H",
    ...
    minDeposit: 5,
    licence: "UKGC licensed",
    pros: ["Partial cash-out available", "Auto cash-out rules", "Fast settlement"],
    cons: ["Fewer niche sports", "Welcome bonus has short expiry"],
    summary:
      "Stands out for its flexible cash-out options including partial and auto cash-out, giving bettors more control over their positions during live events.",
    ratings: { Odds: 4.3, Markets: 4.1, App: 4.4, Payments: 4.5, Support: 4.0 },
    positioning: "Best cash-out features and settlement speed",
  },
  {
    id: "I",
    name: "Bookmaker I",
    label: "Best accumulators",
    color: "#4F46E5",
    rating: 4.0,
    bonus: "Bet £5, Get £20 in Free Bets",
    bonusShort: "£20 Free Bets",
    minDeposit: 5,
    licence: "UKGC licensed",
    pros: ["Acca insurance on 5+ legs", "Daily acca boosts", "Edit-a-bet feature"],
    cons: ["Single bet odds are average", "Limited live streaming"],
    summary:
      "Tailored for accumulator fans with generous acca insurance, daily price boosts on multiples and a unique edit-a-bet tool that lets you swap legs after placement.",
    ratings: { Odds: 4.2, Markets: 4.3, App: 4.2, Payments: 4.3, Support: 4.1 },
    positioning: "Best accumulator offers and acca insurance",
  },
  {
    id: "J",
    name: "Bookmaker J",
    label: "Best for promotions",
    color: "#BE185D",
    rating: 3.9,
    bonus: "Bet £10, Get £30 in Free Bets",
    bonusShort: "£30 Free Bets",
    minDeposit: 10,
    licence: "UKGC licensed",
    pros: ["Weekly free bet clubs", "Loyalty rewards programme", "Regular enhanced odds"],
    cons: ["Interface can feel cluttered", "Withdrawal times above average"],
    summary:
      "Excels at keeping existing customers engaged with weekly free bet clubs, a tiered loyalty programme and regular enhanced odds offers across football and racing.",
    ratings: { Odds: 4.1, Markets: 4.0, App: 3.9, Payments: 4.0, Support: 4.2 },
    positioning: "Best ongoing promotions for existing customers",
  },
];
